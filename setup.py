...
"""
# uvicorn idservice:app --no-access-log --loop uvloop $*
...
setup(
    ...
    description="ID-Service is a distributed ID generator microservice based on FastAPI",  # Optional
    ...
    url="https://github.com/tommyxu/idservice",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="The Python Packaging Authority",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="xuyijun@gmail.com",  # Optional
